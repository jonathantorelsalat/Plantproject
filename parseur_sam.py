...
for i in li:
	...
	try:
		f = open("/store/EQUIPES/PBI/Jonathan/custom_parseur/SRR169"+i+"_trimmed_almult_forparseur.sam", "r")
		lines = f.readlines()
		f.close()
	except:
	...
	Al_un = open("/store/EQUIPES/PBI/Jonathan/custom_parseur/SRR169"+i+"_align_un.txt", "w")
	Al_mult = open("/store/EQUIPES/PBI/Jonathan/custom_parseur/SRR169"+i+"_align_mult.txt", "w")
	n=None
	cpt_mult=0
	cpt_un=0
	num_align=None
